...
![1_初始化调度数据库](image/Chapter_8/1_初始化调度数据库.png)
...
![2_编译xxl-job源码](image/Chapter_8/2_编译xxl-job源码.png)
...
![3_执行器管理](image/Chapter_8/3_执行器管理.png)

![4_编辑执行器](image/Chapter_8/4_编辑执行器.png)
...
![5_手动注册](image/Chapter_8/5_手动注册.png)



## 1.3 任务详解-基础配置

![6_新增任务](image/Chapter_8/6_新增任务.png)
...
![7_基础配置](image/Chapter_8/7_基础配置.png)
...
![8_调度配置](image/Chapter_8/8_调度配置.png)
...
![9_任务配置](image/Chapter_8/9_任务配置.png)
...
![10_阻塞处理策略](image/Chapter_8/10_阻塞处理策略.png)
...
![11_路由策略](image/Chapter_8/11_路由策略.png)
...
![12_修改任务为轮询](image/Chapter_8/12_修改任务为轮询.png)
...
![13_分片广播逻辑_1](image/Chapter_8/13_分片广播逻辑_1.png)

![14_分片广播逻辑_2](image/Chapter_8/14_分片广播逻辑_2.png)
...
![15_创建分片广播执行器](image/Chapter_8/15_创建分片广播执行器.png)

②：创建任务，路由策略为分片广播

![16_创建任务_路由策略为分片广播](image/Chapter_8/16_创建任务_路由策略为分片广播.png)
...
![17_APP端新闻推荐页](image/Chapter_8/17_APP端新闻推荐页.png)
...
![22_定时计算热点文章实现思路_2](image/Chapter_8/22_定时计算热点文章实现思路_2.png)

![18_定时计算热点文章实现思路](image/Chapter_8/18_定时计算热点文章实现思路.png)
...
计算完成热点数据后，需要给每个频道缓存一份数据，所以需要查询所有频道信息

① 在leadnews-feign-api定义远程接口
...
![19_新建执行器](image/Chapter_8/19_新建执行器.png)

新建任务：路由策略为轮询，Cron表达式：0 0 2 * * ? 

![20_新建任务_路由策略为轮询](image/Chapter_8/20_新建任务_路由策略为轮询.png)
...
![21_查询文章接口改造实现思路](image/Chapter_8/21_查询文章接口改造实现思路.png)
